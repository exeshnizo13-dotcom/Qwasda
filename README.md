...
Для portable-режиму розпакуйте `Qwasda-1.5.0-x64.zip` в окрему папку та запустіть `Qwasda.exe`; він не змінює інсталяцію та також не потребує Python.
...
`release.py` створює `artifacts/Qwasda-1.5.0-x64.zip`, `artifacts/Qwasda-Setup-1.5.0-x64.exe`, `artifacts/SHA256SUMS.txt` і підписаний updater manifest.
